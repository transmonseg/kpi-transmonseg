...
export const CAPITULOS: Capitulo[] = [
  // 0 ─ Dashboard: o sistema inteiro num lugar
  {
    ...
    steps: [
      ...
      s('[data-tour="periodo"]', 'Escolha o período', 'Dia, semana, mês, ano — ou "Período" pra um intervalo personalizado (de–até). Tudo no dashboard se ajusta ao que você marcar aqui.'),
