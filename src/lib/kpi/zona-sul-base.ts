...
export const FILIAIS_ZONA_SUL: Array<{ numero: number | string; nome: string }> = [
  ...
  { numero: 8, nome: 'Zona Sul Loja 08 - Ipanema' },
  ...
  { numero: 22, nome: 'Zona Sul Loja 22 - S. Conrado' },
  { numero: 23, nome: 'Zona Sul Loja 23 - Barra' },
  { numero: 24, nome: 'Zona Sul Loja 24 - Penha' },
  { numero: 25, nome: 'Zona Sul Loja 25 - Jd. Botânico' },
  ...
  { numero: 31, nome: 'Zona Sul Loja 31 - Jd. Botânico' },
  ...
  { numero: 1129, nome: 'Zona Sul Loja 1129 - Olaria' },
  ...
  { numero: 'MEGA BOX 2', nome: 'MEGA BOX 02 - Olaria' },
