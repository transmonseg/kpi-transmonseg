...
function fakeMetricas(over: Partial<Metricas> = {}): Metricas {
  return {
    ...
    serie: [
      { data: '2026-05-01', entregue: 30, nao_foi: 2, sem_rastreador: 1, em_rota: 0, total: 33 },
      { data: '2026-05-02', entregue: 40, nao_foi: 1, sem_rastreador: 2, em_rota: 0, total: 43 },
      { data: '2026-05-03', entregue: 40, nao_foi: 3, sem_rastreador: 1, em_rota: 0, total: 44 },
    ],
    topSemRastreador: [
