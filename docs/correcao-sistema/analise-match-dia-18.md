# Análise match placa-por-placa — Dia 18/05/2026

Total placas analisadas: 173
...
**Escala (4 linha(s)):**
- [CARREFOUR] WANDERLEY | loja="Carrefour - Campo Grande" cod=—
- [ZONA_SUL] WANDERLEY | loja="Zona Sul Loja 08 - Ipanema" cod=08
- [ZONA_SUL] WANDERLEY | loja="Zona Sul Loja 42 - Botafogo" cod=42
- [ZONA_SUL] WANDERLEY | loja="Zona Sul Loja 36 - Botafogo" cod=36
...
- ✓ "Zona Sul Loja 36 - Botafogo" → `9039108 36 - ZONA SUL - BOTAFOGO` (nome 2 tokens)
...
- [ZONA_SUL] NILTON RODRIGUES | loja="Zona Sul Loja 19 - Copacabana" cod=19
...
- ✓ "Zona Sul Loja 19 - Copacabana" → `560019 SENDAS FREGUESIA - LOJA 28` (suffix cod 19→560019)
...
- [ZONA_SUL] JOSUE DOS SANTOS | loja="Zona Sul Loja 05 - Copacabana III" cod=05
...
**Escala (1 linha(s)):**
- [ASSAI] ADRIANO | loja="Assaí - Mesquita (Dutra) - Loja 142" cod=142
...
**Escala (1 linha(s)):**
- [ASSAI] EDMARIO | loja="Assaí - Mendanha (Campo Grande) - Loja 65" cod=65
...
- [ZONA_SUL] EVERTON | loja="Zona Sul Loja 47" cod=47
- [ZONA_SUL] EVERTON | loja="Zona Sul Loja 31 - Jd. Botânico" cod=31
- [ZONA_SUL] EVERTON | loja="Zona Sul Loja 10 - Recreio" cod=10
...
**Escala (1 linha(s)):**
- [ZONA_SUL] JONESON | loja="Zona Sul Loja 19 - Copacabana" cod=19
...
- [SUPER_PAX] WILLIAM FERES | loja="Vila da Penha" cod=—
...
- Unitrac: `9006000 CARREFOUR ESPIRITO SANTO`
...
- [FEIRA_NOVA] ESTELITA | loja="6- Santa Cruz da Serra" cod=—
...
**Escala (1 linha(s)):**
- [CARREFOUR] WALLACE FERNANDES | loja="Carrefour - Sulacap" cod=—
...
**Escala (1 linha(s)):**
- [SUPERCOMPRAS] MANOEL PAULINO | loja="SUPERCOMPRAS - COSMOS" cod=—
...
**Escala (1 linha(s)):**
- [ATACADAO] CARLINHOS | loja="Atacadão - Manilha" cod=—

**Unitrac (1 loja(s)):**
- `23843000 ATACADÃO - MANILHA`

**Match resultado:**
- ✓ "Atacadão - Manilha" → `23843000 ATACADÃO - MANILHA` (nome 1 tokens)
...
**Escala (1 linha(s)):**
- [PREZUNIC] MARCELO | loja="Prezunic - Barra da Tijuca" cod=—
...
**Escala (2 linha(s)):**
- [ASSAI] JULIO | loja="Assaí - Petrópolis- Loja 181" cod=181
...
**Escala (2 linha(s)):**
- [ASSAI] ZOZIMO | loja="Assaí - Boulevard (Vila Isabel) - Loja 294" cod=294
...
- Unitrac: `560056 SENDAS BOULEVARD`
- Unitrac: `579011 FEIRA NOVA BOA DICA (PIABETÁ)`
- Unitrac: `7012010 CAB - PETROPOLIS` ⚠ ROTA GIGANTE
...
- [ZONA_SUL] MILTON | loja="Zona Sul Loja 29 - Flamengo" cod=29
- [ZONA_SUL] MILTON | loja="Zona Sul Loja 28 - Urca" cod=28
...
- ✗ "Zona Sul Loja 28 - Urca" → SEM MATCH
...
- [ZONA_SUL] DIEGO | loja="MEGA BOX 02 - Olaria" cod=MEGA
- [ZONA_SUL] DIEGO | loja="Zona Sul Loja 31 - Jd. Botânico" cod=31
...
- ✗ "Zona Sul Loja 31 - Jd. Botânico" → SEM MATCH
...
- [ZONA_SUL] JOSENILDO ANISIO | loja="Zona Sul Loja 26 - Copacabana" cod=26
...
**Escala (1 linha(s)):**
- [ASSAI] RENAN | loja="Assaí - Nova Iguaçu - Loja 30" cod=30
...
- [FEIRA_NOVA] FELIPE | loja="9- Queimados" cod=—
...
**Escala (3 linha(s)):**
- [PREZUNIC] MARCIO | loja="Prezunic - Ilha do Governador" cod=—
- [FEIRA_NOVA] MARCIO | loja="10- Cachambi" cod=—
- [ZONA_SUL] MARCIO | loja="Zona Sul Loja 32 - Laranjeiras" cod=32
...
- [SUPER_PAX] JOHN | loja="Taquara" cod=—
...
- [EMANUEL] WANDERSON | loja="CACHAMORRA" cod=—
...
**Escala (3 linha(s)):**
- [ZONA_SUL] RODRIGO | loja="Zona Sul Loja 10 - Recreio" cod=10
- [ZONA_SUL] RODRIGO | loja="Zona Sul Loja 17 - Barra" cod=17
- [ZONA_SUL] RODRIGO | loja="Zona Sul Loja 12 - Leme" cod=12
...
**Escala (1 linha(s)):**
- [ATACADAO] MAGACIEL | loja="Atacadão - Belford Roxo" cod=—

**Unitrac (1 loja(s)):**
- `23843003 ATACADÃO - BELFORD ROXO`

**Match resultado:**
- ✓ "Atacadão - Belford Roxo" → `23843003 ATACADÃO - BELFORD ROXO` (nome 2 tokens)
...
- `20577000 INDUSTRIAS DE BEBIDAS JOAQUIM THOMAS DE AQUINO FILHO SA` ⚠ rota gigante
- `579004 FEIRA NOVA IRAJÁ`
...
**Escala (3 linha(s)):**
- [ZONA_SUL] JHONATA FREIRE DA SILVA | loja="Zona Sul Loja 08 - Ipanema" cod=08
...
- Unitrac: `9006159 CARREFOUR MACAE`
...
**Escala (3 linha(s)):**
- [PREZUNIC] FÁBIO BORGES | loja="Prezunic - Tijuca" cod=—
- [SAMS_CLUB] FÁBIO BORGES | loja="Sam's - Linha Amarela" cod=—
- [ZONA_SUL] FÁBIO BORGES | loja="Zona Sul Loja 44 - Barra" cod=44
...
**Escala (1 linha(s)):**
- [ZONA_SUL] LUIZ ALVES | loja="Zona Sul Loja 14 - Leblon" cod=14
...
**Escala (3 linha(s)):**
- [ZONA_SUL] SÉRGIO JOSE DA SILVA* | loja="Zona Sul Loja 1129 - Olaria" cod=1129
- [ZONA_SUL] SÉRGIO JOSE DA SILVA* | loja="MEGA BOX 01 - Olaria" cod=MEGA
- [ZONA_SUL] SÉRGIO JOSE DA SILVA | loja="Zona Sul Loja 17 - Barra" cod=17
...
- [ZONA_SUL] AGNALDO | loja="MEGA BOX 02 - Olaria" cod=MEGA
...
- [ZONA_SUL] ALEX | loja="Zona Sul Loja 03 - Copacabana I" cod=03

**Unitrac (3 loja(s)):**
- `9039003 03 - ZONA SUL - COPACABANA`
- `9039004 04 - ZONA SUL - COPACABANA II`
- `9039018 18 - ZONA SUL - COPACABANA`

**Match resultado:**
- ✗ "MEGA BOX 01 - Olaria" → SEM MATCH
- ✓ "Zona Sul Loja 03 - Copacabana I" → `9039003 03 - ZONA SUL - COPACABANA` (suffix cod 03→9039003)
...
**Escala (2 linha(s)):**
- [PREZUNIC] HELIO ALVES | loja="Prezunic - Jardim Oceanico" cod=—
- [PREZUNIC] HELIO ALVES | loja="Prezunic - Barra Marapendi" cod=—

**Unitrac (3 loja(s)):**
- `7000753 PREZUNIC JARDIM OCEÂNICO`
- `7000765 PREZUNIC BARRA MARAPENDI`
- `71032 GB 07 - BARRA`

**Match resultado:**
- ✓ "Prezunic - Jardim Oceanico" → `7000753 PREZUNIC JARDIM OCEÂNICO` (nome 2 tokens)
- ✓ "Prezunic - Barra Marapendi" → `7000765 PREZUNIC BARRA MARAPENDI` (nome 2 tokens)
...
**Escala (1 linha(s)):**
- [ZONA_SUL] CARLOS GONÇALVES | loja="Zona Sul Loja 01 - Ipanema" cod=01
...
**Escala (1 linha(s)):**
- [ASSAI] SÉRGIO FIDÉLIS | loja="Assaí - Nova Iguaçu 2 - Loja 291" cod=291
...
**Escala (1 linha(s)):**
- [ZONA_SUL] EDUARDO | loja="Zona Sul Loja 23 - Barra" cod=23
...
**Escala (2 linha(s)):**
- [PREZUNIC] SIDNEI | loja="Prezunic - Pechincha" cod=—
...
**Escala (2 linha(s)):**
- [ZONA_SUL] INACIO ARAUJO | loja="Zona Sul Loja 46 - Botafogo" cod=46
- [ZONA_SUL] INACIO ARAUJO | loja="Zona Sul Loja 36 - Botafogo" cod=36
...
**Escala (2 linha(s)):**
- [PREZUNIC] SIMÃO | loja="Prezunic - Cachambi" cod=—
- [EMANUEL] SIMÃO | loja="ALHAMBRA" cod=—
...
- [FEIRA_NOVA] ANDRE | loja="12- Freguesia" cod=—
...
**Escala (1 linha(s)):**
- [ZONA_SUL] DOUGLAS | loja="Zona Sul Loja 43 - Barra (Península)" cod=43
...
- [ZONA_SUL] MARCIO | loja="Zona Sul Loja 40 - Ipanema" cod=40
...
**Escala (1 linha(s)):**
- [ZONA_SUL] EDMILSON JOSÉ | loja="Zona Sul Loja 25 - Jd. Botânico" cod=25
...
**Escala (1 linha(s)):**
- [ZONA_SUL] ANDERSON | loja="Zona Sul Loja 40 - Ipanema" cod=40
...
**Escala (1 linha(s)):**
- [ZONA_SUL] PAULO ROBERTO | loja="Zona Sul Loja 20 - Botafogo" cod=20
...
**Escala (1 linha(s)):**
- [ASSAI] JOSIAS | loja="Assaí - Sabão Rio (Benfica) - Loja 136" cod=136
...
**Escala (1 linha(s)):**
- [ASSAI] ANTONIO RODRIGUES | loja="Assaí - Galeão - Loja 302" cod=302
...
**Escala (1 linha(s)):**
- [ASSAI] JOSÉ LUZIMAR | loja="Assaí - São João do Meriti  - Loja 217" cod=217
...
**Escala (2 linha(s)):**
- [ZONA_SUL] EDUARDO | loja="Zona Sul Loja 25 - Jd. Botânico" cod=25
- [ZONA_SUL] EDUARDO | loja="Zona Sul Loja 22 - S. Conrado" cod=22
...
**Escala (3 linha(s)):**
- [ASSAI] LUCIANO MATIAS | loja="Assaí - Bangu II - Loja 332" cod=332
- [ARMAZEM_GRAO] SILVIO ALVES | loja="ARMAZEM DO GRÃO (CAPELA)" cod=—
- [ARMAZEM_GRAO] SILVIO ALVES | loja="ARMAZEM DO GRAO (16 DE MARÇO)" cod=—
...
**Escala (1 linha(s)):**
- [ASSAI] VALDEMIRIO | loja="Assaí - São Gonçalo Centro - Loja 266" cod=266
...
- Unitrac: `25414000 NATURCONGELADOS` ⚠ ROTA GIGANTE
...
- ✗ "REGINA  BARRA DO IMBUY" → SEM MATCH
- ✗ "REGINA  1 DE MAIO" → SEM MATCH
- ✗ "REGINA  LUCIO MEIRA" → SEM MATCH
- ✗ "ABASTECEDORA GRÃO DA SERRA (ALTO)" → SEM MATCH

**Diagnóstico:** ⚠ OK_PARCIAL (2/6)

---
## RJL7D33

**Escala (2 linha(s)):**
- [ZONA_SUL] FRANCISCO IRAN | loja="Zona Sul Loja 47" cod=47
- [ZONA_SUL] FRANCISCO IRAN | loja="Zona Sul Loja 45 - Flamengo" cod=45
...
**Match resultado:**
- ✗ "Zona Sul Loja 47" → SEM MATCH
- ✗ "Zona Sul Loja 45 - Flamengo" → SEM MATCH
...
**Escala (1 linha(s)):**
- [ASSAI] VICTOR LUIZ | loja="AssaÍ - Ilha do Governador - Loja 29" cod=29
...
**Match resultado:**
- ✓ "Princesa - Iguaba (1º Entrega)" → `8590570 PRINCESA - IGUABA GRANDE` (nome 1 tokens)
- ✓ "Princesa - Itaboraí (2ª Entrega)" → `8590573 PRINCESA ITABORAÍ` (nome 1 tokens)
...
**Escala (5 linha(s)):**
- [PREZUNIC] JOSE ROBERTO | loja="Prezunic - Nilópolis" cod=—
- [VIANENSE] JOSE ROBERTO | loja="Vianense - Recreio 1º entrega" cod=—
- [VIANENSE] JOSE ROBERTO | loja="Vianense - Freguesia 2º entrega" cod=—
- [FEIRA_NOVA] JOSE ROBERTO | loja="1- Nilopolis (Olinda)" cod=—
- [ZONA_SUL] JOSE ROBERTO | loja="Zona Sul Loja 34 - Barra" cod=34
...
- ✗ "Zona Sul Loja 34 - Barra" → SEM MATCH
...
- [ZONA_SUL] JONATHAN MARCIO | loja="Zona Sul Loja 09 - Ipanema" cod=09
...
**Escala (1 linha(s)):**
- [SUPER_PAX] DENIS BEZERRA | loja="Sepetiba" cod=—
...
**Escala (1 linha(s)):**
- [ASSAI] CLEBER SODRE | loja="Assaí - Boulevard (Vila Isabel) - Loja 294" cod=294
...
**Escala (3 linha(s)):**
- [ASSAI] ERALDO | loja="Assaí - Caxias II (Parque Fluminense) - Loja 219" cod=219
...
- `560057 SENDAS CAXIAS II (PARQUE FLUMINENSE)`

**Match resultado:**
- ✓ "Assaí - Caxias II (Parque Fluminense) - Loja 219" → `560057 SENDAS CAXIAS II (PARQUE FLUMINENSE)` (nome 4 tokens)
...
**Escala (1 linha(s)):**
- [ASSAI] JOSE MARTINS | loja="Assaí - Alcântara I - Loja 35" cod=35
...
**Escala (1 linha(s)):**
- [PREZUNIC] BRUNO | loja="Prezunic - Botafogo (Voluntários)" cod=—
...
**Escala (3 linha(s)):**
- [PREZUNIC] RODRIGO (2º ENTREGA) | loja="Prezunic - Botafogo (Voluntários)" cod=—
- [PREZUNIC] RODRIGO | loja="Prezunic - Padre Miguel" cod=—
- [ZONA_SUL] RODRIGO | loja="Zona Sul Loja 28 - Urca" cod=28
...
**Escala (2 linha(s)):**
- [SENDAS] YAGO | loja="CAB - PETRÓPOLIS" cod=—
- [EMANUEL] BRUNO PEREIRA | loja="VARGEM_GRANDE" cod=—
...
- [ZONA_SUL] MATHEUS | loja="Zona Sul Loja 34 - Barra" cod=34
...
**Escala (3 linha(s)):**
- [ASSAI] JEFERSON BATALHA | loja="Assaí - Niterói Ponte - Loja 292" cod=292
- [SUPER_PAX] JEFERSON BATALHA | loja="Inhauma" cod=—
- [SUPER_PAX] JEFERSON BATALHA | loja="Engenho de Dentro" cod=—
...
- `5353016 REGINA LUCIO MEIRA` ⚠ rota gigante
- `5353017 ABASTECEDORA GRÃO DA SERRA (ALTO)` ⚠ rota gigante
- `560052 SENDAS NITERÓI PONTE`

**Match resultado:**
- ✓ "Assaí - Niterói Ponte - Loja 292" → `560052 SENDAS NITERÓI PONTE` (nome 2 tokens)
...
**Escala (2 linha(s)):**
- [ARMAZEM_GRAO] JAIRO | loja="ARMAZEM DO GRÃO (ITAIPAVA)" cod=—
- [ARMAZEM_GRAO] JAIRO | loja="ARMAZEM DO GRAO (CORREAS)" cod=—
...
- [ZONA_SUL] FERNANDO CARDOSO | loja="Zona Sul Loja 35 - Barra" cod=35
...
- [ZONA_SUL] MARCOS FERNANDO | loja="Zona Sul Loja 38 - Copacabana" cod=38
...
**Escala (1 linha(s)):**
- [CARREFOUR] FELIPE DIEGO | loja="Carrefour - Juiz de Fora" cod=—
