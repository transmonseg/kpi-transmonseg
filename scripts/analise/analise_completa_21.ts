/**
 * Análise placa a placa — ZONA SUL 21/05/2026
...
async function main() {
  ...
  const veiculos = await parseUnitrac(readFileSync(BASE + '/relatorio_9552.xlsx'))
  ...
  const kpiM = await lerKpi('C:/Users/media/Downloads/KPI-ZONA_SUL-2026-05-21.xlsx')
  ...
  process.stdout.write('=== ANÁLISE PLACA A PLACA — ZONA SUL 21/05/2026 ===\n')
