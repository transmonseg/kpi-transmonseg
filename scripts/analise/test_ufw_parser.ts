...
;(async () => {
  const veiculos = await parseUnitracPdf(
    readFileSync('C:/Users/media/OneDrive/Desktop/EMPRESA TRIFORCE AUTO/clientes/tia-erica/CONVERSAS COM ERICA/ESCALA DIA 21/relatorio_9553.pdf'),
    new Set()
  )
  const v = veiculos.find(x => x.placa_norm === 'UFW0H63')!
