...
--
-- Achado real 05/09: a API aberta da Unitrac so' lista a frota por COD_USER
-- (/veiculos/masn/{cod}), e o cod_user da conta Rio Quality nao foi
-- descoberto (so' o emprecodigo=598, que esse endpoint nao aceita, e nao
-- vale a pena tentar achar por tentativa -- ver docs/plans/2026-09-05-kpi-
-- rio-quality.md, "risco de expor frota de outra empresa"). Os CVs abaixo
-- foram coletados na tela Monitoramento > Veiculos do portal (login da
-- Erica, filtro EMPRESA = RIO QUALITY, paginado ate' o fim -- 85 de
-- 102 veiculos, atualizado 05/09 apos completar a paginacao que na primeira
-- coleta parou em 59). Placa sem CV aqui sai no KPI como "sem cadastro" ate'
-- completarmos a lista (ou descobrirmos o cod_user, quando esta tabela vira
-- so' cache).
--
